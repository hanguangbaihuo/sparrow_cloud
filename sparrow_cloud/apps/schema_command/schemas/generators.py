...
class EndpointEnumerator(object):
    ...
    def should_include_endpoint(self, path, callback):
        ...
        if callback.cls.schema is None:
            return False
        if hasattr(callback, "initkwargs") and 'schema' in callback.initkwargs:
...
class SchemaGenerator(object):
    ...
    def __init__(self, title=None, url=None, description=None, patterns=None, urlconf=None):
        ...
        self.coerce_method_names = incompatible_settings.SCHEMA_COERCE_METHOD_NAMES
        self.coerce_path_pk = incompatible_settings.SCHEMA_COERCE_PATH_PK
        self.patterns = patterns
