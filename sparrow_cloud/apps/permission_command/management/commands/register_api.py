...
class Command(BaseCommand):
    ...
    def handle(self, auth_centre, dj_ver,local, *args, **kwargs):
        ...
        if dj_ver == "2":
            generator = self.get_schema_generator("permission_command.generators_django_1.OpenAPISchemaGenerator", "API",
                                                  "1.0")
        else:
            generator = self.get_schema_generator("permission_command.generators_django_2.SchemaGenerator", "API",
                                                  "1.0")
